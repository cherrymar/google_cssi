...
def seed_data():
    ...
    ron_wand=Wand(length = 14.0, material = "willow", core="unicorn", parent=ron_key)
    harry_wand=Wand(length = 11.0, material = "holly", core="phoenix feather", parent=harry_key)
    hermione_wand = Wand(length=10.75, material="vinewood", core="dragon heartstring", parent=hermione_key)
